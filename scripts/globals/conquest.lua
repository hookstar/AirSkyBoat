...
local expRings =
{
    [xi.item.CHARIOT_BAND] = { cp = 350, charges = 7, costPerCharge = 50 },
    [xi.item.EMPRESS_BAND] = { cp = 700, charges = 7, costPerCharge = 100 },
    [xi.item.EMPEROR_BAND] = { cp = 600, charges = 3, costPerCharge = 200 },
}

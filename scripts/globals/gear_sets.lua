...
local gearSets =
{
    ...
    [100] = -- AF1 119 +2/3 DRK
    {
        items =
        {
            ...
            xi.item.IGNOMINY_BURGONET_P2,
            xi.item.IGNOMINY_BURGONET_P3,
        },
        minEquipped = 2,
        maxEquipped = 5,
        mods =
    ...
    [115] = -- AF1 119 +2/3 RUN
    {
        ...
        {
            xi.item.REGAL_RING,
            xi.item.RUNEISTS_BOOTS_P2,
            xi.item.RUNEISTS_BOOTS_P3,
            xi.item.RUNIESTS_TROUSERS_P2,
            xi.item.RUNEISTS_TROUSERS_P3,
            xi.item.RUNEISTS_MITONS_P2,
            xi.item.RUNEISTS_MITONS_P3,
            xi.item.RUNEISTS_COAT_P2,
            xi.item.RUNEISTS_COAT_P3,
            xi.item.RUNEISTS_BANDEAU_P2,
            xi.item.RUNEISTS_BANDEAU_P3,
        },
        minEquipped = 2,
        maxEquipped = 5,
        mods =
        ...
        if setCount >= minEquippedReq then
            ...
            for _, modData in ipairs(gearSets[setId].mods) do
                if
                    setId >= 47 and
                    setId <= 53 and
                    player:getEquipID(xi.slot.AMMO) == xi.item.VIRTUE_STONE
                then

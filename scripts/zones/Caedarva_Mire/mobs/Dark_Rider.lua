...
local entity = {}
local initialSpawnPoint = -- Initial Spawnpoint for Dark Rider in Caedarva Mire
{
    [1] = { 340, 4, -719 },
    [2] = { 540, -18, -402 },
    [3] = { -274, -2, -700 },
...
local pathNodes1 = -- todo clean up this table!
{
    ...
    { x = 265.3194, y = -12.3335, z = -386.105, },
...
local pathNodes2 = -- todo clean up this table!
{
    ...
    { x = 371.8016, y = -19.6807, z = -369.3657, },
    ...
    { x = 155.5187, y = -7.9717, z = -478.6031, },
...
local pathNodes3 = -- todo clean up this table!
{
    ...
    { x = -396.8808, y = -0.3133, z = -726.4492, },
    ...
    { x = -460.4145, y = 11.5608, z = -527.4645, },
...
entity.onMobSpawn = function(mob, npc)
    ...
    if selectedIndex == 1 then
        mob:pathThrough(pathNodes1, bit.bor(xi.path.flag.PATROL))
    elseif selectedIndex == 2 then
        mob:pathThrough(pathNodes2, bit.bor(xi.path.flag.PATROL))
    elseif selectedIndex == 3 then
        mob:pathThrough(pathNodes3, bit.bor(xi.path.flag.PATROL))
    end
end
...
entity.onMobDespawn = function(mob, player)
    ...
    local selectedHoofprint = math.random(1, 40)

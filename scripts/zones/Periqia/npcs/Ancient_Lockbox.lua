...
entity.onTrigger = function(player, npc)
    local qItem =
    {
        ...
        {
            {
                ...
                { itemid = xi.item.UNAPPRAISED_SHIELD,  droprate = 250 },
                { itemid = xi.item.UNAPPRAISED_POLEARM, droprate = 200 },
                { itemid = xi.item.UNAPPRAISED_AXE,     droprate =  50 },
            },
        },
        ...
        [xi.assault.mission.BUILDING_BRIDGES] =
        {
            {
                { itemid = xi.item.UNAPPRAISED_BOX,     droprate = 400 },
                { itemid = xi.item.UNAPPRAISED_POLEARM, droprate = 100 },
                { itemid = xi.item.UNAPPRAISED_AXE,     droprate = 400 },
            },
        },
        ...
        {
            {
                ...
                { itemid = xi.item.UNAPPRAISED_SWORD,   droprate = 100 },
                { itemid = xi.item.UNAPPRAISED_POLEARM, droprate = 100 },
                { itemid = xi.item.UNAPPRAISED_BOX,     droprate = 200 },
            },
        },
    }
    ...
    local regItem =
    {
        ...
        [xi.assault.mission.SAVING_PRIVATE_RYAAF] =
        {
            ...
            {
                { itemid = xi.item.HI_POTION_TANK, droprate = 200 },
                { itemid = 0,                       droprate = 800 },
            },
            {
        ...
        [xi.assault.mission.BUILDING_BRIDGES] =
        {
            ...
            {
                { itemid = xi.item.HI_RERAISER,    droprate = 250 },
                { itemid = 0,                       droprate = 750 },
            },
        },
        ...
        [xi.assault.mission.STOP_THE_BLOODSHED] =
        {
            ...
            {
                { itemid = xi.item.REMEDY,         droprate = 300 },
                { itemid = 0,                       droprate = 700 },
            },
        },
    }

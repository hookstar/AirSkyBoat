...
zones[xi.zone.SPIRE_OF_DEM] =
{
    text =
    {
        ...
        PARTY_MEMBERS_ARE_ENGAGED     = 7066, -- You are cleared to enter the battlefield, but you cannot while party members are engaged in combat.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7614, -- Entering the battlefield for “{e:1:select}[Ancient Flames Beckon/You Are What You Eat/Empty Dreams]”!

...
local loot =
{
    ...
    [80] =
    {
        ...
        },
        {
            ...
            { itemid = xi.item.HANDFUL_OF_WYVERN_SCALES, droprate = 50 },
    ...
    [81] =
    {
...

        {
            ...
            { itemid = xi.item.CLAYMORE_GRIP, droprate =  86 },
            { itemid = xi.item.POLE_GRIP,     droprate = 146 },
            { itemid = xi.item.SWORD_STRAP,   droprate = 220 },
        },
    ...
    [82] =
    {
...

        {
            ...
            { itemid = xi.item.CLAYMORE_GRIP, droprate = 144 },

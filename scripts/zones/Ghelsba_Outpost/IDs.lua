...
zones[xi.zone.GHELSBA_OUTPOST] =
{
    text =
    {
        ...
        TIME_IN_THE_BATTLEFIELD_IS_UP    = 164, -- Your time in the battlefield is up!\x07Now exiting...
        PARTY_MEMBERS_ARE_ENGAGED        = 165, -- You are cleared to enter the battlefield,   but you cannot while party members are engaged in combat.
        NO_BATTLEFIELD_ENTRY             = 181, -- You are not cleared to enter the battlefield
        UNABLE_TO_PROTECT                = 218,  -- You were unable to protect the special character. Now leaving the battlefield.
        MEMBERS_OF_YOUR_PARTY            = 470, -- Currently,                                  {e:3} members of your party (including yourself) have clearance to enter the battlefield.
        MEMBERS_OF_YOUR_ALLIANCE         = 471, -- Currently,                                  {e:3} members of your alliance (including yourself) have clearance to enter the battlefield.
        TIME_LIMIT_FOR_THIS_BATTLE_IS    = 473, -- The time limit for this battle is {e:3} minutes.
        THERE_IS_A_CRACK                 = 474, -- There is a crack in the <01052382838080>. It no longer contains a monster.
        A_CRACK_HAS_FORMED               = 475, -- A crack has formed on the <01052382838080>, and the beast inside has been unleashed!<7F31>
        ...
        ENTERING_THE_BATTLEFIELD_FOR     = 7749, -- Entering the battlefield for Save The Children/The Holy Crest/Wings of Fury/Petrifying Pair/Toadal Recall/Mirror,Mirror.

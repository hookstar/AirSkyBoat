...
zones[xi.zone.SPIRE_OF_MEA] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7078, -- You are not cleared to enter the battlefield.\x07Now exiting...<7F3401><7F31>
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7614, -- Entering the battlefield for “{e:1:select}[Ancient Flames Beckon/Playing Host/Empty Desires]”!
    },
    mob =
    {
    },

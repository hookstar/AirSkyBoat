-----------------------------------
-- Area: Waojaom Woodlands
-- MOB: Dark Rider
-- MOBID: 16986421
-- hoofprint 16986601
-- warhorse footprints (A hoofprint will always spawn coinciding with the path of the Dark Rider
--between the hours of 00:00 and 02:00 and will de-spawn at 06:00 a whole game day later
--(meaning that the Key Item is active for between 28 and 30 in-game hours, or between 70 and 80 Earth minutes)
...
local entity = {}
local initialSpawnPoint = -- Initial Spawnpoint for Dark Rider in Wajaom_Woodlands
{
    [1] = { -424, -26, 417, },
    [2] = { -745, -12 , -520, },
    [3] = { 385, -20 , 399, },
...
local selectedIndex = math.random(1, 3)
...
local pathNodes1 = -- todo clean up this table!
{
    ...
    { x = -260.5822, y = -18.8131, z = -375.9417, },
}
...
local pathNodes2 = -- todo clean up this table!
{
    ...
    { x = -621.2643, y = -17.4003, z = -259.9261, },
    ...
    { x = -284.8363, y = -15.9495, z = 79.5762, },
    ...
    { x = -110.5886, y = -19.9136, z = -254.2155, },
}
...
local pathNodes3 = -- todo clean up this table!
{
    ...
    { x = -269.0372, y = -27.8614, z = 431.0944, },
...
entity.onMobDespawn = function(mob, player)
    ...
    local selectedHoofprint = math.random(1, 30)

...
content:addEssentialMobs({ "Watch_Hippogryph"})
...
content.loot =
{
...

    {
        ...
        { itemid = xi.items.RASIE_ROD, droprate = xi.battlefield.dropChance.LOW },
    },

    {
        { itemid = xi.items.NONE, droprate = xi.battlefield.dropChance.HIGH },
        { itemid = xi.items.KSHAMA_RING_NO_2, droprate = xi.battlefield.dropChance.LOW },
        { itemid = xi.items.KSHAMA_RING_NO_3, droprate = xi.battlefield.dropChance.LOW },
        ...
        { itemid = xi.items.KSHAMA_RING_NO_6, droprate = xi.battlefield.dropChance.LOW },
        { itemid = xi.items.KSHAMA_RING_NO_8, droprate = xi.battlefield.dropChance.LOW },

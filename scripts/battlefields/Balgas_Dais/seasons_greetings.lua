-----------------------------------
-- Seasons Greetings KSNM 30 (CLOTHO ORB)
-- Balgas Dais
-- !pos 298 -124 343 146
-----------------------------------
...
{
    {
        { itemid = xi.items.THURSUSSTAB, droprate = xi.battlefield.dropChance.NORMAL },
        ...
        { itemid = xi.items.SUBDUER, droprate = xi.battlefield.dropChance.NORMAL },
        { itemid = xi.items.EXPUNGER, droprate = xi.battlefield.dropChance.NORMAL },
    },

    {
        { itemid = xi.items.DURANDAL, droprate = xi.battlefield.dropChance.NORMAL },
        { itemid = xi.items.HOPLITES_HARP, droprate = xi.battlefield.dropChance.NORMAL },
        { itemid = xi.items.SORROWFUL_HARP, droprate = xi.battlefield.dropChance.NORMAL },
        { itemid = xi.items.ATTILAS_EARRING, droprate = xi.battlefield.dropChance.NORMAL },
    },

    {
        ...
        { itemid = xi.items.ROOT_SABOTS, droprate = xi.battlefield.dropChance.NORMAL },
    },

    {
        { itemid = xi.items.DIVINE_LOG, droprate = xi.battlefield.dropChance.HIGH },
        { itemid = xi.items.LACQUER_TREE_LOG, droprate = xi.battlefield.dropChance.LOW },
